      ...
      <div class="flex items-center gap-4 relative">
        ...
        <div class="relative">
          <div class="relative cursor-pointer" @click="toggleDropdown">
            <div 
              class="h-8 w-8 rounded-full bg-slate-200 dark:bg-slate-600 bg-center bg-cover border-2 border-slate-200 dark:border-slate-700" 
            ...
            ></div>
            <div v-if="authStore.isLoggedIn" class="absolute bottom-0 right-0 bg-green-500 rounded-full p-0.5 border border-white dark:border-slate-800" title="在线">
          ...
          >
            ...
            <div class="flex flex-col items-center gap-4 pt-2">
              ...
              <div class="relative">
                <div 
                  class="h-20 w-20 rounded-full bg-slate-200 dark:bg-slate-600 bg-center bg-cover border-4 border-slate-100 dark:border-slate-700" 
                  :style="authStore.isLoggedIn ? `background-image: url('${authStore.userInfo?.avatar || 'https://lh3.googleusercontent.com/aida-public/AB6AXuCViKVOfHqt2-9UnYUpEzs287y79wFyt5RgXZoljAsZiXY1Yv6Ek-JedzvHPJdmnvPaDQe6xgkvDKfWJHAcfPSGQrRelaSox-PHSs0Nw6IHc50RANilEH_OBiupphEPR5sK43w8MznzWnnkXMRoOg77t61Aw0TR_VfYZgRPlsim9N9UWKAW1KgC9Bdq644UXAxAEUgFcFrPmz35qhR5jbyKyb11O8RrueWZmCT7fpDh2HLrhusLNEZrm4hrS8jwyQEb7bIRcBNaenJw'}');` : 'background-image: url(https://ui-avatars.com/api/?name=请登录&background=0D8ABC&color=fff);'"
                ></div>
                <div v-if="authStore.isLoggedIn" class="absolute bottom-1 right-1 bg-green-500 rounded-full p-1 border-2 border-white dark:border-slate-800" title="在线">
